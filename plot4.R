...
plot(strptime(paste(powCons$Date,powCons$Time),format="%Y-%m-%d %H:%M:%S"),powCons$Global_reactive_power,
    type="l",xlab="datetime",ylab="Global_reactive_power",main="", bg="transparent", cex=0.75)
